...
class IngredientsTest < ApplicationSystemTestCase
  ...
  test "creating a Ingredient" do
    ...
    fill_in "Id ingredient", with: @ingredient.id_ingredient
    fill_in "Measure ingredient", with: @ingredient.measure_ingredient
    fill_in "Name ingredient", with: @ingredient.name_ingredient
