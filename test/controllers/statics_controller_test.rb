...
class StaticsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create static" do
    assert_difference('Static.count') do
      post statics_url, params: { static: { count_menu: @static.count_menu, id_menu: @static.id_menu, id_statics: @static.id_statics, score_menu: @static.score_menu } }
    end
  ...
  test "should update static" do
    patch static_url(@static), params: { static: { count_menu: @static.count_menu, id_menu: @static.id_menu, id_statics: @static.id_statics, score_menu: @static.score_menu } }
