...
class PantriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pantry" do
    assert_difference('Pantry.count') do
      post pantries_url, params: { pantry: { ingredient_pauntry: @pantry.ingredient_pauntry, quantity_pauntry: @pantry.quantity_pauntry } }
    end
  ...
  test "should update pantry" do
    patch pantry_url(@pantry), params: { pantry: { ingredient_pauntry: @pantry.ingredient_pauntry, quantity_pauntry: @pantry.quantity_pauntry } }
